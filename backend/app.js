...
// Pour accéder à l'API depuis l'origine indiqué, les headers mentionnés aux requêtes envoyées vers l'API et pour envoyer des requêtes avec les méthodes mentionnées
